...
const FACTORY_ADDRESS = "0xAFFB294BD52FD5039Cee68f08FaC0974723eB1B8";
...
async function main() {
	...
	const owners = [address0, address1, address2].map(addr => addr.toLowerCase()).sort((a, b) => a.localeCompare(b));
	...
	//   console.log(`Deposit to ${sender} successfull`);
	...
	const signers = [signer0, signer1, signer2].sort((a, b) => 
